...
window.$ = JQUERY;
var GOLDEN_LAYOUT = require("golden-layout");

var ipcRenderer = window.API.ELECTRON.ipcRenderer;

exports.main = function (JSONREP, node) {

    return JSONREP.markupNode(node).then(function (html) {

        return JSONREP.makeRep('<div style="width: 100%; height: 100%;"></div>', {
            on: {
                    ...
                    try {
                        ...
                        layout.registerComponent('doc', function (container, componentState) {
                            ...
                            function setHTML(html) {
                                ...
                                container.getElement().html(['<div style="padding: 2px; height: 100%; box-sizing: border-box;">', '<div style="background-color: white; height: 100%; box-sizing: border-box; padding: 5px;">', html, '</div>', '</div>'].join("\n"));
